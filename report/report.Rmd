...
In this report, we summarize the steps we took toward replicating the results in Chapter 3, Linear Regression, from the book "An Introduction to Statistical Learning" by James et al. In this project, we apply computational toolkits such as lm function, graphic devices and essential elements that enable a reproducible workflow to reproduce the simple regression analysis. 
...
By running linear regression with the data set the book provides, we are able to replicate the result and arrive at the conclusion that there exists a strong linear relationship between the TV advertising budget and sales. 
